"""
Text viewer tab for rendering file contents as decoded text.

Supports multiple encoding detection (via chardet), paginated viewing for
large files, and built-in decoders for Base64, hex, URL-encoded, HTML-entity,
octal, and binary-encoded strings. Includes bidirectional search with
highlighting.
"""
