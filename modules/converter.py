"""
Disk image format converter for converting between RAW (dd) and EWF (E01) formats.

Provides a dialog for selecting source images and target formats, with
threaded conversion using pyewf for E01 creation and raw byte streaming
for dd output.
"""
