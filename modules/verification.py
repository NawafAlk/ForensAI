"""
Evidence integrity verification widget for forensic disk images.

Calculates MD5, SHA-1, and SHA-256 hashes of loaded evidence files in a
background thread and displays results for chain-of-custody documentation.
"""
...
class VerificationWidget(QWidget):
    def __init__(self, image_handler, parent=None):
        ...
        self.image_handler = image_handler
        self.setWindowTitle("ForensAI - Image Verification")
        ...
        self.software_info = QLabel("ForensAI - Forensic Analysis Tool", self)
        ...
        if hash_results:
            ...
            if self.image_handler.get_image_type() == "ewf":
                ...
                verification_results.append(
                    f"<b>MD5 Verify result:</b> {md5_result}<br>")
                ...
                verification_results.append(
                    f"<b>SHA1 Verify result:</b> {sha1_result}<br>")
