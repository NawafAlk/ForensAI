"""
EXIF metadata viewer for image files within forensic disk images.

Extracts and displays EXIF tags (camera model, GPS coordinates, timestamps,
etc.) from JPEG and TIFF files using the Pillow library.
"""
