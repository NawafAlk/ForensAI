...
class MainWindow(QMainWindow):
    """
    Primary application window orchestrating all forensic analysis components.

    Manages image loading, partition tree navigation, evidence file selection,
    and coordination between analysis tabs (hex, text, metadata, EXIF, registry,
    file carving, risk scoring, timeline, and AI-powered dashboards).
    """
    ...
    def initialize_ui(self):
        ...
        # Light Theme Action (default - FTK Imager style)
        ...
        # **Apply the default stylesheet (light theme - FTK style)**
        self.apply_stylesheet('light')

        tools_menu = QMenu('Tools', self)

        acquire_action = QAction("Create Disk Image", self)
        acquire_action.setStatusTip("Acquire physical disk or logical drive/partition")
        ...
        # Selection colors now handled by QSS theme
